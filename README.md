...
Now edit the file `./etc/nginx/approov-secret.jwk`, and add the correct values for `approov-base64url-secret-here` and `unique-identifier-for-the-approov-base64url-secret-here`:


```json
{"keys":
    [{
        "k":"approov-base64url-secret-here",
        "kty":"oct",
        "kid":"unique-identifier-for-the-approov-base64url-secret-here"
    }]
}
```
